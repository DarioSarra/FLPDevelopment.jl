...
Age_Rewards.test
Age_Rewards.groupdf
savefig(joinpath(replace(path,basename(path)=>""),"Development_Figures","Review", "Age_Rewards.pdf"))
##
...
Cas_Rewards.test
Cas_Rewards.groupdf
savefig(joinpath(replace(path,basename(path)=>""),"Development_Figures","Review", "Cas_Rewards.pdf"))
